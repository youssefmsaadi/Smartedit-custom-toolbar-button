...
const karma = compose(
    merge({
        junitReporter: {
            outputDir: 'jsTarget/tests/smartedittrailcommons/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: lodash.concat(
            ...
            bundlePaths.test.unit.commonUtilModules, [
                ...
                'jsTests/tests/smartedittrailcommons/unit/specBundle.ts'
            ]
        ),
