...
<em>smartedittrail/web/features/smartedittrailContainer/smartedittrailcontainermodule.ts</em>
```ts
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the smartedittrail:
- <em>smartedittrail/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>smartedittrail/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'smartedittrail' layer of smartedittrail is a bundle of smartedittrail and smartedittrailcommons.
The 'smartedittrailContainer' layer of smartedittrail is a bundle of smartedittrailContainer and smartedittrailcommons.
